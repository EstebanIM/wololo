    ...
    const handleAddOrEditAuto = async (e) => {
        ...
        try {
            if (editingAuto) {
                ...
                setAutos(
                    autos.map((a) =>
                        a.id === currentAutoId ? { ...auto, id: currentAutoId } : a
                    )
                );
                Swal.fire(
                    "Actualizado",
                    "El auto ha sido actualizado correctamente",
                    "success"
                );
            } else {
    ...
    const handleAddOrEditCotizacion = async (e) => {
        ...
        try {
            if (editingCotizacion) {
                ...
                setCotizaciones(
                    cotizaciones.map((c) =>
                        c.id === currentCotizacionId
                            ? { ...cotizacion, id: currentCotizacionId }
                            : c
                    )
                );
                Swal.fire(
                ...
                Swal.fire(
                    "Agregado",
                    "La cotización ha sido agregada correctamente",
                    "success"
                );
            }
        } catch (error) {
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-4">
                    <div className="flex flex-col md:flex-row md:space-x-8">
                        {/* Sección de Autos */}
                        <div className="w-full md:w-1/2 p-4 bg-white shadow-md rounded-lg flex flex-col mb-6 md:mb-0">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        setShowAutoModal(true);
                                        setEditingAuto(false);
                                        setAuto({ marca: "", modelo: "", year: "", patente: "", tipoMotor: "", color: "" });
                                    }}
                                >
                                    Agregar Vehículo
                                </Button>
                            ...
                            {/* Listado de autos */}
                            <ul className="flex-1 flex flex-col items-start mb-6 space-y-4"> {/* Asegura el alineado */}
                                {autos.map((auto) => (
                                    <li key={auto.id} className="flex justify-between items-start w-full">
                            ...
                            >
                                <h2 className="text-xl font-bold mb-4">
                                    {editingAuto ? "Editar Auto" : "Agregar Nuevo Auto"}
                                </h2>
                                <form onSubmit={handleAddOrEditAuto}>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setAuto({ ...auto, tipoMotor: e.target.value })
                                        }
                                    ...
                                    <Input
                                        ...
                                        value={auto.color}
                                        onChange={(e) =>
                                            setAuto({ ...auto, color: e.target.value })
                                        }
                                        placeholder="Color"
                                        className="mb-4"
                                    />
                        ...
                        <div className="w-full md:w-1/2 p-4 bg-white shadow-md rounded-lg flex flex-col justify-between">
                            ...
                            <ul className="flex-1 flex flex-col items-start mb-6 space-y-4">
                                {cotizaciones.map((cotizacion) => (
                                    ...
                                    >
                                        <span>
                                            {cotizacion.fecha} - {cotizacion.taller} (
                                            {cotizacion.tipoMantencion})
                                        </span>
                                        <div className="flex space-x-2">
                                            <Button
                                                variant="default"
                            ...
                            >
                                ...
                                <form onSubmit={handleAddOrEditCotizacion}>
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setCotizacion({ ...cotizacion, fecha: e.target.value })
                                        }
                                        placeholder="Fecha"
                                        className="mb-4"
                                        type="date"
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setCotizacion({ ...cotizacion, taller: e.target.value })
                                        }
                                        placeholder="Taller"
                                        className="mb-4"
                                    />
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setCotizacion({ ...cotizacion, detalle: e.target.value })
                                        }
